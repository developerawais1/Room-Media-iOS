...
class GroupListController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        self.suggestedBtn.setTitle(NSLocalizedString("Suggested Roomz", comment: "Suggested Roomz"), for: .normal)
        self.exploreLabel.text = NSLocalizedString("Explore Roomz", comment: "Explore Roomz")
