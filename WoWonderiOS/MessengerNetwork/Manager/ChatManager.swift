...
class ChatManager{
    ...
    func getUserChats(user_id: String, session_Token: String,receipent_id:String, completionBlock: @escaping (_ Success:UserChatModel.UserChatSuccessModel?,_ AuthError:UserChatModel.UserChatErrorModel?,_ ServerKeyError:UserChatModel.ServerKeyErrorModel?, Error?) ->()){
        ...
        AF.request(API.Chat_Methods.GET_USER_CHATS_API, method: .post, parameters: params, encoding:URLEncoding.default , headers: nil).responseJSON { (response) in
            print(params)
    ...
    func sendMessage(message_hash_id: Int,receipent_id:String,text:String,session_Token:String,lat:Double,long:Double, completionBlock: @escaping (_ Success:SendMessageModel.SendMessageSuccessModel?,_ AuthError:SendMessageModel.SendMessageErrorModel?,_ ServerKeyError:SendMessageModel.ServerKeyErrorModel?, Error?) ->()){
    ...
    func sendChatData(message_hash_id: Int,receipent_id:String,session_Token: String,type:String, audio_data:Data? ,image_data:Data?,video_data:Data?,imageMimeType:String?,videoMimeType:String?, audioMimeType:String?,text:String,file_data:Data?,file_Extension:String?,fileMimeType:String?, completionBlock: @escaping (_ Success:SendMessageModel.SendMessageSuccessModel?,_ AuthError:SendMessageModel.SendMessageErrorModel?,_ ServerKeyError:SendMessageModel.ServerKeyErrorModel?, Error?) ->()){
        ...
        }, to: API.Chat_Methods.SEND_MESSAGE_API + "\(session_Token)", method: .post, headers: headers).response { (result) in
