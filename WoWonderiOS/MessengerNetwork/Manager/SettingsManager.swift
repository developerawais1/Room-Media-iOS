...
class SettingsManager{
    ...
    func updateUserProfile(session_Token: String,firstname:String,lastname:String,gender:String,location:String,phone:String,website:String,school:String,facebook:String,google:String,twitter:String,youtube:String,VK:String,instagram:String, completionBlock: @escaping (_ Success:MessengerUpdateUserDataModel.MessengerUpdateUserDataSuccessModel?,_ AuthError:MessengerUpdateUserDataModel.UpdateUserDataErrorModel?,_ ServerKeyError:MessengerUpdateUserDataModel.ServerKeyErrorModel?, Error?) ->()){
        ...
        let params = [
            ...
            API.Params.ServerKey : APIClient.SERVER_KEY.Server_Key
        ] as [String : Any]
        ...
        AF.request(API.Settings_Methods.UPDATE_USER_PROFILE_API + "\(session_Token)", method: .post, parameters: params, encoding:URLEncoding.default , headers: nil).responseJSON { (response) in
            if (response.value != nil){
                ...
                if apiStatus is Int{
                    ...
                    let result = try? JSONDecoder().decode(MessengerUpdateUserDataModel.MessengerUpdateUserDataSuccessModel.self, from: data!)
                    ...
                    if apiStatusString == "400" {
                        ...
                        let data = try? JSONSerialization.data(withJSONObject: response.value, options: [])
                        let result = try? JSONDecoder().decode(MessengerUpdateUserDataModel.UpdateUserDataErrorModel.self, from: data!)
                        log.error("AuthError = \(result?.errors!.errorText)")
                        completionBlock(nil,result,nil,nil)
                    }else if apiStatusString == "404" {
                        let data = try? JSONSerialization.data(withJSONObject: response.value, options: [])
                        let result = try? JSONDecoder().decode(MessengerUpdateUserDataModel.ServerKeyErrorModel.self, from: data!)
                        log.error("AuthError = \(result?.errors!.errorText)")
    ...
    func updateAboutMe(session_Token: String,aboutme:String, completionBlock: @escaping (_ Success:MessengerUpdateUserDataModel.MessengerUpdateUserDataSuccessModel?,_ AuthError:MessengerUpdateUserDataModel.UpdateUserDataErrorModel?,_ ServerKeyError:MessengerUpdateUserDataModel.ServerKeyErrorModel?, Error?) ->()){
    ...
    func updateMyAccount(session_Token: String,email:String,username:String,gender:String, completionBlock: @escaping (_ Success:MessengerUpdateUserDataModel.MessengerUpdateUserDataSuccessModel?,_ AuthError:MessengerUpdateUserDataModel.UpdateUserDataErrorModel?,_ ServerKeyError:MessengerUpdateUserDataModel.ServerKeyErrorModel?, Error?) ->()){
    ...
    func updatePassword(session_Token: String,currentPassword:String,newPassword:String, completionBlock: @escaping (_ Success:MessengerUpdateUserDataModel.MessengerUpdateUserDataSuccessModel?,_ AuthError:MessengerUpdateUserDataModel.UpdateUserDataErrorModel?,_ ServerKeyError:MessengerUpdateUserDataModel.ServerKeyErrorModel?, Error?) ->()){
    ...
    func updateUserDataWithCandA(session_Token: String,firstname:String,lastname:String,gender:String,location:String,phone:String,website:String,school:String,facebook:String,google:String,twitter:String,youtube:String,VK:String,instagram:String,type:String,avatar_data:Data?,cover_data:Data?, completionBlock: @escaping (_ Success:MessengerUpdateUserDataModel.MessengerUpdateUserDataSuccessModel?,_ AuthError:MessengerUpdateUserDataModel.UpdateUserDataErrorModel?,_ ServerKeyError:MessengerUpdateUserDataModel.ServerKeyErrorModel?, Error?) ->()){
        ...
        }, to: API.Settings_Methods.UPDATE_USER_PROFILE_API + "\(session_Token)", method: .post, headers: headers).response { (result) in
...
//                        completionBlock(nil,nil,nil,response.error)
    ...
    func updateTwoStepVerification(session_Token: String,type: String, completionBlock: @escaping (_ Success:MessengerUpdateUserDataModel.MessengerUpdateUserDataSuccessModel?,_ AuthError:MessengerUpdateUserDataModel.UpdateUserDataErrorModel?,_ ServerKeyError:MessengerUpdateUserDataModel.ServerKeyErrorModel?, Error?) ->()){
    ...
    func updatePrivacy(session_Token: String,key: String,value:Int,completionBlock :@escaping (_ Success:MessengerUpdateUserDataModel.MessengerUpdateUserDataSuccessModel?,_ AuthError:MessengerUpdateUserDataModel.UpdateUserDataErrorModel?,_ ServerKeyError:MessengerUpdateUserDataModel.ServerKeyErrorModel?, Error?)->()){
        let params = [
            API.Params.ServerKey:APIClient.SERVER_KEY.Server_Key,
            key:value
