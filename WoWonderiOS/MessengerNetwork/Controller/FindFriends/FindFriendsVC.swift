...
class FindFriendsVC: BaseVC {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.noUserImage.tintColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
    ...
    @IBAction func filterPressed(_ sender: Any) {
        let vc  = R.storyboard.chat.filterVC()!
        let controller = SheetViewController(controller:vc )
        controller.hasBlurBackground = false
        vc.delegate = self
