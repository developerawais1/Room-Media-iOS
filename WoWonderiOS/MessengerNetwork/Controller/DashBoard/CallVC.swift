...
class CallVC: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.phoneBtn.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
        self.phoneImage.tintColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
        setupUI()
