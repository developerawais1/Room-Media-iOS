...
class FollowingVC: BaseVC {
    ...
    private let color = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
    ...
    func setupUI(){
        self.showStackImage.tintColor = UIColor.hexStringToUIColor(hex: ControlSettings.appMainColor)
        self.searchRandomBtn.backgroundColor = UIColor.hexStringToUIColor(hex: ControlSettings.buttonColor)
