...
class MessengerCreateGroupModel:BaseModel{
    struct MessengerCreateGroupSuccessModel: Codable {
        let apiStatus: Int?
        let data: [Datum]?
...
class MessengerDeleteGroupModel:BaseModel{
    struct MessengerDeleteGroupSuccessModel: Codable {
        let apiStatus: Int?
        let messageData: String?
